      ...
      <div style="font-family: Arial, sans-serif; background:#0f172a; padding:30px;">
        <div style="max-width:600px; margin:auto; background:#1e293b; color:white; border-radius:14px; overflow:hidden;">
          ...
          <div style="background:#2563eb; padding:25px; text-align:center;">
            ...
            <p style="margin:8px 0 0; color:#dbeafe;">Password Reset Request</p>
          </div>
          ...
          <div style="padding:30px;">
            ...
            <div style="text-align:center; margin:35px 0;">
              <a href="${resetLink}"
                 style="background:#3b6ff5; color:white; padding:14px 28px; text-decoration:none; border-radius:8px; font-weight:bold; display:inline-block;">
                Reset Password
              </a>
            </div>
            ...
            <p style="font-size:14px; word-break:break-all; color:#93c5fd;">
              ${resetLink}
            </p>
...
router.post("/forgot-password", async (req, res) => {
  ...
  try {
    ...
    // Security: do not clearly expose whether email exists
    if (users.length === 0) {
      return res.render("forgot-password", {
        email,
    ...
    res.render("forgot-password", {
      ...
      submitted_email: "",
      error: null,
      success: "Password reset link has been sent. Please check your inbox or spam folder.",
      message: "Password reset link has been sent. Please check your inbox or spam folder.",
    });
  } catch (err) {
